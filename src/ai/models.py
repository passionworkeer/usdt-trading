...
class EvidenceBasedDecision:
    """
    An evidence-based trading decision.

    This is the core decision structure that aggregates evidence from multiple
    sources (technical analysis, sentiment analysis, on-chain metrics, etc.)
    to produce a trading decision with risk management parameters.

    Attributes:
        action: The trading action to take (BUY, SELL, or PASS)
        evidence_count: Total number of evidence points supporting this decision
        evidence_chain: List of evidence descriptions in order of importance
        veto_flag: If True, this decision should be vetoed despite evidence
    ...
    def is_valid(self) -> bool:
        """Check if this decision is valid and should be executed."""
        if self.veto_flag:
            return False
        if self.action == ActionType.PASS:
            return False
...
class TradingSignal:
    ...
    def is_actionable(self) -> bool:
        ...
        return (
            self.signal_type != ActionType.PASS
